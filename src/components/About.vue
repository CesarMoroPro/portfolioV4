        ...
        <section class="general-about">
                ...
                <div class="general-about__texts" v-show="isAboutSectionOpen">
                        ...
                        <div class="english-bio">
                                <p class="general-texts"><span class="flags">🏴󠁧󠁢󠁥󠁮󠁧󠁿</span> Coming from a professional retraining with <a href="https://oclock.io/" target="blank" class="link-white link-background-orange">O'clock School</a> (Paris), I am available right now to put my skill to your benefit.</p>
...
export default {
        ...
        methods: {
                openSection() {
                        if (this.isAboutSectionOpen === false) {
                                this.isAboutSectionOpen = true;
                        } else {
